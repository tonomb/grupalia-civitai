  ...
  return (
    <div className="absolute top-4 right-4">
      <div className="relative">
        ...
        />
        {moreOptionsVisible && (
          <div className="text-white absolute top-center bg-[#1A1C1E] rounded-sm p-4 z-10 left-1/2 transform -translate-x-1/2 mt-2 w-[300px]">
            <ul className="gap-1 flex flex-col">
              {imageOptions.map((imageOption) => {
                return <ImageOption imageOption={imageOption} />;
              })}
            </ul>
          </div>
        )}
